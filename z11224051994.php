...
<!--        <link href="css/bootstrap-theme.min.css" rel="stylesheet">-->
    ...
    {
        echo '<META HTTP-EQUIV="refresh" CONTENT="1;URL=q78945341inter.php">';
    }
        ...
        if (isset($_POST['upload'])) 
    {
        ...
        if(in_array($type1, $allowedExts) OR in_array($type2, $allowedExts))
        {
                ...
                move_uploaded_file($_FILES["file1"]["tmp_name"],$a);
                  ...
                  if(mysqli_query($connection,"INSERT INTO `question` (`number`, `path`, `popup`, `answer`) VALUES ('$number', '$a', '$b', '$answer')"))
                  {
                    ?>

                         <div id="saveAlert" class="alert-message success fade in" data-alert="alert" style="top:0">
  <a class="close" href="z11224051994.php">×</a>
           ...
           <?php
            ...
            if(isset($_POST['delete_user']))
            {
                ...
                mysqli_query($connection,$query);
                 echo ' <META HTTP-EQUIV="refresh" CONTENT="2;URL=z11224051994.php"> ';
            }
            ?>
</table>
